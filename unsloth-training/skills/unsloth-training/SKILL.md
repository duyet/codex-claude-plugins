...
**Installation:** → pip, uv, Colab, CUDA versions
→ Reference: `reference/installation.md`

**Dataset preparation:** → Formats, chat templates, synthetic data, multi-column
→ Reference: `reference/datasets-guide.md`

**Environment flags:** → UNSLOTH_RETURN_LOGITS, COMPILE_DISABLE, etc.
→ Reference: `reference/environment-flags.md`

**Apple Silicon / MLX:** → unsloth-mlx, Mac training
→ Reference: `reference/mlx-training.md`
